...
public class Minister 
{
     ...
     public static void main(String[] args) 
     {
           ...
           // create a Thread that checks the amount of
     ...
     private class CollectionChecker extends Thread 
     {
         public void run() 
         {
              // check the amount of money in the collection plate. If it's
              // less than 100, then release the collection plate, so other
